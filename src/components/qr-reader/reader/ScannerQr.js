        ...
        <div className='scanner-qr'>
            {recording ? (
                ...
                <>
                    ...
                    <div className='flex-center'>
                        <div className='scanner-result'>
                            {VALORES_CORRECTOS.includes(result) ? `(${result}) se encuentra en el Array con los valores correctos` : `NO se ha podido encontrar el valor (${result}) en el Array con los valores correctos.`}
                        </div>
                    </div>
                    <div className='flex-center'>
